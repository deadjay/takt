...
struct EventDetailView: View {
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    if hasDeadline, let daysLeft = computeDaysLeft() {
                        HStack(spacing: 8) {
                            Circle()
                                .fill(daysLeft == "Overdue" ? Color.red : TaktsTheme.accent)
                                .frame(width: 8, height: 8)

                            Text(daysLeft.uppercased())
                                .font(.system(size: 11, weight: .heavy, design: .monospaced))
                                .foregroundColor(daysLeft == "Overdue" ? .red : TaktsTheme.accent)
                        }
                    }
                    ...
                    VStack(spacing: 12) {
                        ...
                        Button {
                            ...
                            Text("SAVE EVENT")
                                ...
                                .shadow(color: TaktsTheme.accent.opacity(0.3), radius: 10, y: 5)
                        }
            ...
            .background(TaktsTheme.appBackground)
