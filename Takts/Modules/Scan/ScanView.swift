        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("Snap a photo, upload an image, or paste text — Takts extracts dates and creates reminders automatically.")
                        .font(.system(size: 15))
                ...
                VStack(spacing: 10) {
                    ...
                    VStack(spacing: 6) {
                        RoundedRectangle(cornerRadius: 12)
                            .strokeBorder(TaktsTheme.textMuted.opacity(0.4), style: StrokeStyle(lineWidth: 1.5, dash: [6, 4]))
                            .frame(height: 80)
                            .overlay {
                                VStack(spacing: 2) {
                    ...
                    Button {
                        ...
                        HStack(spacing: 12) {
                            Text("DETECT EVENTS")
                                .font(TaktsTheme.magicButtonFont)
                                .tracking(1.8)
                        ...
                        .frame(height: TaktsTheme.magicButtonHeight)
                        .background(TaktsTheme.accent)
                        .clipShape(RoundedRectangle(cornerRadius: TaktsTheme.magicButtonCornerRadius))
                        .shadow(color: TaktsTheme.accent.opacity(0.30), radius: 15, y: 8)
                    }
        ...
        .overlay {
            if isDropTargeted {
                RoundedRectangle(cornerRadius: 20)
                    .stroke(TaktsTheme.accent, lineWidth: 3)
                    .background(TaktsTheme.accent.opacity(0.08))
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            Image(systemName: "xmark.circle.fill")
                                .font(.system(size: 28))
                                .foregroundColor(TaktsTheme.textMuted.opacity(0.5))
                        }
                    }
                ...
                .padding(TaktsTheme.contentPadding)
                .padding(.top, 8)
            }
        }
                ...
                if !isDisabled {
                    if !text.isEmpty {
                        Button {
                            ...
                            Image(systemName: "xmark.circle.fill")
                                .font(.system(size: 18))
                                .foregroundColor(TaktsTheme.textMuted.opacity(0.6))
                        }
                    } else {
                        Button {
                            onPaste()
                            ...
                            Text("Paste")
                                ...
                                .padding(.vertical, 6)
                                .background(TaktsTheme.accent.opacity(0.1))
                                .clipShape(RoundedRectangle(cornerRadius: 8))
                        }
                    }
                }
